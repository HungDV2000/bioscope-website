...
const STRINGS: Record<'vi' | 'en', AuthFormStrings & { close: string; tabLogin: string; tabRegister: string; benefit: string }> = {
  vi: {
    ...
    phone: 'Số điện thoại',
    customerType: {
      legend: 'Bạn đăng ký với tư cách',
      business: 'Doanh nghiệp',
      businessHint: 'Công ty, nhà máy, đơn vị phân phối',
      individual: 'Cá nhân',
      individualHint: 'Nghiên cứu viên, dược sĩ, khách lẻ',
    },
  ...
  en: {
    ...
    phone: 'Phone number',
    customerType: {
      legend: 'You are registering as',
      business: 'Business',
      businessHint: 'Company, factory, distributor',
      individual: 'Individual',
      individualHint: 'Researcher, pharmacist, retail buyer',
    },
