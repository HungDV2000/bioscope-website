...
export const ChatConversations: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'visitorIp', type: 'text', admin: { readOnly: true }, label: { en: 'IP', vi: 'Địa chỉ IP' } },
    { name: 'location', type: 'text', admin: { readOnly: true }, label: { en: 'Location', vi: 'Vị trí (thành phố/quốc gia)' } },
