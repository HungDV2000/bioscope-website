...
export interface ApiCertificationCertification
  ...
  attributes: {
    ...
    kind: Schema.Attribute.Enumeration<['certificate', 'stat', 'award']> &
...
export interface ApiGatedDocumentGatedDocument
  extends Struct.CollectionTypeSchema {
  collectionName: 'gated_documents';
  info: {
    displayName: 'Gated Document';
    pluralName: 'gated-documents';
    singularName: 'gated-document';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    allowedMembers: Schema.Attribute.Relation<
      'manyToMany',
    ...
    docType: Schema.Attribute.Enumeration<
      ['COA', 'spec_sheet', 'quote', 'brochure']
    > &
      Schema.Attribute.DefaultTo<'COA'>;
    file: Schema.Attribute.Media<'images' | 'files' | 'videos'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::gated-document.gated-document'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    relatesTo: Schema.Attribute.Relation<
      'manyToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visibility: Schema.Attribute.Enumeration<['approved_members', 'specific']> &
      Schema.Attribute.DefaultTo<'approved_members'>;
  };
}
...
export interface ApiIngredientCategoryIngredientCategory
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    scope: Schema.Attribute.Enumeration<['supplement', 'cosmetic', 'both']> &
...
export interface ApiIngredientIngredient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    type: Schema.Attribute.Enumeration<['supplement', 'cosmetic']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'supplement'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    layout: Schema.Attribute.DynamicZone<
      ['blocks.hero', 'blocks.rich-text', 'blocks.stats', 'blocks.cta']
    >;
    locale: Schema.Attribute.String;
...
export interface ApiTechnologyTechnology extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::technology.technology'
    >;
    mechanism: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::gated-document.gated-document': ApiGatedDocumentGatedDocument;
