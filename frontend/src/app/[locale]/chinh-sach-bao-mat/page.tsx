...
const sections = {
  vi: [
    ...
    { h: "5. Quyền của bạn", p: "Bạn có quyền truy cập, chỉnh sửa hoặc yêu cầu xóa thông tin cá nhân của mình bằng cách liên hệ info@bioscope.vn." },
  ],
  en: [
    ...
    { h: "5. Your rights", p: "You have the right to access, correct or request deletion of your personal data by contacting info@bioscope.vn." },
  ],
};
